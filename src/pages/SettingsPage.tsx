...
const sections = [
  ...
  { icon: Database, label: "Data & Storage", desc: "Supabase connection, backups" },
    ...
    <div className="flex flex-col h-full bg-background overflow-y-auto">
      ...
      <div className="flex-1 px-4 md:px-8 py-6">
        <div className="grid gap-3 max-w-lg">
          {sections.map((s) => (
            <div key={s.label} className="bg-card border border-border rounded-xl p-4 flex items-center gap-4 hover:border-primary/30 transition-colors cursor-pointer">
